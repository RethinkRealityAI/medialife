...
export const PROGRAM = {
  ...
  economics: {
    royaltyOnPlatform: 0.1, // share of net sales on direct/on-platform commerce
...
export const PRODUCTS = [
  {
    ...
    blurb:
      "The volume driver. Heavyweight cotton, screen or DTG print, activation woven into the care label.",
    lead: "4–7 weeks (U.S.)",
    hero: true,
  },
  {
    ...
    blurb:
      "Highest value per unit and the strongest signal of real fandom. Fleece-back, embroidered or printed.",
  ...
  },
  {
    ...
    blurb:
      "Proven at RDC. Low price, high attach, and it travels — the most-tapped format we produce.",
    lead: "6–13 weeks (intl.)",
    hero: true,
  },
  {
    ...
    blurb:
      "The character play. Turns a in-experience mascot into an object a fan keeps on a desk for years.",
    lead: "6–13 weeks (intl.)",
    hero: true,
  },
  {
    ...
    blurb:
      "Entry price point and the cheapest way to put an activation into a lot of hands quickly.",
    lead: "4–7 weeks (U.S.)",
    hero: false,
  },
  {
    ...
    blurb:
      "Sits under the mouse of the exact person who plays your experience. Large-format art surface.",
    lead: "6–13 weeks (intl.)",
    hero: false,
  },
];
...
export const ACTIVATIONS = [
  {
    ...
    label: "Tap",
    blurb:
      "A chip in the garment or charm. The fan holds a phone near it and the experience opens. No camera, no app, no typing.",
  },
  {
    id: "qr",
    name: "QR",
    label: "Scan",
    blurb:
      "A printed code on the hem, tag or backing card. Works on every phone made in the last decade, and on packaging before the box is opened.",
  },
  {
    id: "both",
    name: "NFC + QR",
    label: "Tap or scan",
    blurb:
      "Both paths on one product. Highest activation rate — the fan uses whichever is closest to hand. This is our default.",
  },
];
