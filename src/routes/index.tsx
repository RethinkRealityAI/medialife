      ...
      <section className="relative border-b border-border overflow-hidden">
        ...
        <div className="relative mx-auto w-full px-8 lg:px-16 py-14 lg:py-16 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            ...
            <h2 className="mt-6 text-4xl md:text-5xl font-medium tracking-tight text-balance leading-[0.95]">
            ...
            <ul className="mt-8 grid sm:grid-cols-3 gap-px bg-border border border-border max-w-xl">
              {[
                ["Roblox", "Exclusive in-game unlock"],
                ["Scan", "QR on the reverse"],
                ["Limited", "While stock lasts"],
              ].map(([k, v]) => (
                <li key={k} className="bg-background p-3.5">
                  <div className="text-lg font-medium ember-text">{k}</div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              ...
              >
                <span className="ember-shine font-medium">Want this for your IP?</span>
                <span
                  aria-hidden
